  ...
  'inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 gap-1 [&>svg]:size-3 transition-colors',
  {
    variants: {
      variant: {
        ...
        success:
          'border-transparent bg-[color-mix(in_oklch,var(--success)_14%,transparent)] text-[var(--success)]',
        warning:
          'border-transparent bg-[color-mix(in_oklch,var(--warning)_18%,transparent)] text-[color-mix(in_oklch,var(--warning)_70%,black)]',
        destructive:
